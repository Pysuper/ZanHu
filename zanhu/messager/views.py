...
from zanhu.utils.helper import ajax_required
...
def send_message(request):
    ...
    if len(message.strip()) != 0 and sender != recipient:
        ...
        payload = {
            'type': 'receive',  # 代表的是consumers文件中的receive方法
            'message': render_to_string('messager/single_message.html', {"message": msg}),  # render_to_string，把模板渲染成字符串
