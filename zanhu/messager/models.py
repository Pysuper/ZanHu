...
class MessageQuerySet(models.query.QuerySet):
    ...
    def get_conversation(self, sender, recipient):
        ...
        return qs_one.union(qs_two).order_by('created_at')  # 取并集后按时间排序==> union()对两个查询集取并集
...
class Message(models.Model):
    ...
    recipient = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='received_messages', blank=True, null=True, on_delete=models.SET_NULL, verbose_name='接受者')
