...
class NotificationQuerySet(models.query.QuerySet):
    ...
    def mark_all_as_unread(self, recipient=None):
        ...
        # TODO：Django ORM 是惰性执行的，只会在最后操作数据库的时候，执行一次
...
class Notification(models.Model):
    ...
    actor = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="notify_actor", on_delete=models.CASCADE, verbose_name="触发者")
    recipient = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=False, related_name="notifications", on_delete=models.CASCADE, verbose_name='接收者')
